...
class HuffmanApp:
    def __init__(self, root):
        ...
        self.compress_button = tk.Button(root, text="Start Compression", font=("Arial", 12), command=self.start_compression, state=tk.DISABLED, relief="raised",bg="#3498DB", fg="white"
)
